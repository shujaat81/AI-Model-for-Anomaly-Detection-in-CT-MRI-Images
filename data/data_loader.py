...
from config import *
from data.preprocessing import load_images_from_folder, normalize_images, create_data_generators, visualize_samples
...
def load_dataset():
    ...
    train_gen, val_gen, train_images, val_images = create_data_generators(ct_images_normalized)
    ...
    return {
        ...
        'mri': {
            'all_images': mri_images_normalized
        }
    }
